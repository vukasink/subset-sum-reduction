...
def main():
	...
	for dimension in dimensions:
		...
		for N in N_array:
			mkdir = "instances/n_" + str(dimension) + "/N_" + str(N)
		...
		for N in N_array:
			for i in range(NUM_INSTANCES):
				...
				filename_path = "instances/n_" + str(dimension) + "/N_" + str(N) + "/"
				generate_input_file_fplll(filename_path, i + 1, instance, N, lattice_type="Schnorr")
